...
sum_data.loc[sum_data['Pclass'] == 3,'Pclass'] = 0
...
predictors = ['Sex','Title','Age','FAF','Embarked','Cabin','Pclass','Fare']
UseFlag = traindata['Survived'].values
UseFeature = traindata[predictors].values
rf = RandomForestClassifier(random_state=1,n_estimators=100,min_samples_split=6,min_samples_leaf=2)
