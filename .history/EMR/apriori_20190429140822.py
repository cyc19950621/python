...
if __name__ == '__main__':
    minS = 0.8
    dataSet = [['这个','弄','鞍山', '挨打'], ['这个', '啊'], ['鞍山', '弄', '词典', '按错'], ['鞍山', '挨打','按下','爱玩'], ['鞍山', '弄', '词典', '按错'], ['鞍山', '挨打','按下','爱玩']]
    apriori = apriori_algorithm(minSupport=minS, dataSet=dataSet)
    
    L, support_data = apriori.generate_L(dataSet,2,minS)
 
    #print(L)
    #print(support_data)
    big_rule_list = apriori.generate_big_rules(L, support_data, 0.8)
    print(big_rule_list)